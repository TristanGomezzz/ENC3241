...
Job postings will be collected from platforms such as LinkedIn and Indeed and grouped into two time periods:
	• Pre AI growth period (2019–2021)
	• Post AI adoption period (2023–2026)
The analysis will extract and compare:
	• Number of entry level actuarial positions
	• Frequency of required technical skills (e.g., Python, R, machine learning)
	• Mentions of AI related tools and predictive modeling techniques
Skill frequencies will be quantified and compared across both periods to identify measurable changes in employer expectations.
2. Skill Trend Analysis
Using the collected dataset, this study will:
	• Identify increases in demand for programming and machine learning skills
	• Analyze shifts toward data analysis, visualization, and automation tools
	• Compare traditional actuarial requirements with emerging technical expectations
3. Interviews (Qualitative Data)
Semi structured interviews will be conducted with:
	• 5–8 actuarial professionals (e.g., hiring managers, analysts, credentialed actuaries)
	• 2–3 students pursuing actuarial science or related fields (for comparison)
Interview topics will include:
	• The role of AI in actuarial workflows
	• Changes in hiring expectations and required skills
	• Perceptions of how AI is shaping early career opportunities
4. Data Analysis
...
The intended audience includes:
	...
	• University faculty and academic advisors
	• Career services departments
	• Early career job seekers in finance and insurance
This research will:
...
Software	&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;			$0			&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;				$0			&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;	UCF provides required tools (Python, Excel, etc.)
